...
export const MainBanner = () => {
  return (
    <div className='relative'>
        ...
        md:justify-center pb-24 md:pb-8 px-4 md:pl-18 lg:pl-24'>
            <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-center
            md:text-left max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15'>
              Quality you can rely on, savings you’ll adore.
            </h1>
        ...
        <div className='flex items-center mt-6 font-medium'>
            ...
            <Link to={"/products"} className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>
                Explore Deals
                <img className='transition group-hover:translate-x-1' src={assets.black_arrow_icon} alt='arro'/>
            </Link>
        </div>
        </div>
    </div>
