      ...
      <div className="md:p-10 p-4 space-y-4">
        ...
        {orders.length === 0 ? (
          ...
          orders.map((order, index) => (
            <div
              key={index}
              className="flex flex-col md:grid md:grid-cols-2 gap-5 justify-between p-5 max-w-4xl rounded-md border border-gray-300"
            >
              <div className="flex flex-col">
                <div className="flex gap-5 max-w-80 mb-4">
